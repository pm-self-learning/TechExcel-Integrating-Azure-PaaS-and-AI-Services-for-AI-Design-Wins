...
[KernelFunction]
    ...
    /// <summary>
    /// Get all bookings that are missing hotel rooms.
    /// </summary>
...
[KernelFunction]
    ...
    /// <summary>
    /// Get all bookings that have multiple hotel rooms.
    /// </summary>
public async Task<IEnumerable<Booking>> GetBookingsWithMultipleHotelRooms()
    ...
    public async Task<IEnumerable<Booking>> GetBookingsByHotelAndMinimumDate([Description("The ID of the hotel")] int hotelId, [Description("Specific date time for hotel booking")]  DateTime dt)
    {
